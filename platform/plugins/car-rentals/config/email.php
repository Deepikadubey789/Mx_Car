...
return [
    ...
    'templates' => [
        ...
        'trip-reminder' => [
            'title' => 'Trip Reminder',
            'description' => 'Send trip reminder email to customer 1 day before pickup',
        ...
        'return-alert' => [
            'title' => 'Return Alert',
            'description' => 'Send return alert email to customer on return date',
            'subject' => 'Reminder: Please Return Your Car Tomorrow',
            'can_off' => true,
            'variables' => [
                'booking_code' => 'plugins/car-rentals::settings.email.templates.booking_confirm.booking_code',
                'customer_name' => 'plugins/car-rentals::settings.email.templates.booking_confirm.customer_name',

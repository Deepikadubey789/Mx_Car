...
mix
    ...
    .sass(`${source}/resources/sass/overview.scss`, `${dist}/css/overview-custom.css`)
    ...
    .js(`${source}/resources/js/car-pricing-calendar.js`, `${dist}/js`)
...
if (mix.inProduction()) {
    mix
        ...
        .copy(`${dist}/css/overview-custom.css`, `${source}/public/css`)
        ...
        .copy(`${dist}/js/car-pricing-calendar.js`, `${source}/public/js`)

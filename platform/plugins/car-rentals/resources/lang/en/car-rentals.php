...
return [
    ...
    'pricing_policy' => [
        'name' => 'Pricing Policy',
        'helper' => 'Configure host-level discount and mileage rules. Manual calendar overrides still take priority for specific dates.',
        'weekly_discount_type' => 'Weekly Discount Type',
        'weekly_discount_value' => 'Weekly Discount Value',
        'monthly_discount_type' => 'Monthly Discount Type',
        'monthly_discount_value' => 'Monthly Discount Value',
        'included_distance_per_day' => 'Included Distance Per Day',
        'included_distance_per_trip' => 'Included Distance Per Trip',
        'extra_distance_unit_price' => 'Extra Distance Unit Price',
        'distance_unit' => 'Distance Unit',
        'distance_overage_billing_mode' => 'Mileage Billing Mode',
        'allow_best_discount_only' => 'Apply only the best available discount',
        'max_discount_cap_percent' => 'Maximum Discount Cap (%)',
        'trip_discount_rules' => 'Trip-Length Discount Rules',
        'trip_discount_rules_helper' => 'Add bands like 3-6 days, 7-13 days, or 14+ days. The engine will pick the best single discount.',
        'add_trip_discount_rule' => 'Add Rule',
        'min_days' => 'Min Days',
        'max_days' => 'Max Days',
    ...
    'price_breakdown' => [
        'toggle' => 'See price details',
        'base_rental' => 'Base rental',
        'rental_days' => 'Rental days',
        'policy_discount' => 'Host discount',
        'rental_after_policy_discount' => 'Rental after host discount',
        'services_subtotal' => 'Services subtotal',
        'insurance_subtotal' => 'Insurance subtotal',
        'tax' => 'Taxes',
        'service_fee' => 'Service fee',
        'deposit_hold' => 'Refundable deposit hold',
        'deposit_fixed' => 'Fixed hold amount',
        'deposit_percentage' => ':rate% of trip charges',
        'deposit_base' => 'Deposit calculation base',
        'distance_rules' => 'Distance policy: includes :limit :unit per trip, then :rate/:unit billed (:mode).',
        'discount_sources' => [
            'weekly' => 'Weekly discount applied',
            'monthly' => 'Monthly discount applied',
            'trip_rule' => 'Trip-length discount applied',
            'combined' => 'Combined discounts applied',
            'fallback' => 'Promotional discount applied',
        ],
        'billing_modes' => [
            'end_of_trip' => 'charged at end of trip',
            'prepaid_estimate' => 'prepaid estimate mode',
            'both' => 'estimate + end-of-trip adjustments',
        ],
    ],
];

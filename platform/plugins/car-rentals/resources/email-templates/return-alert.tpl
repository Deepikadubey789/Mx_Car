    ...
    <table class="bb-box" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="bb-content bb-pb-0" align="center">
                ...
                <h1 class="bb-text-center bb-m-0 bb-mt-md">Car Return Reminder</h1>
            </td>
        </tr>
        <tr>
            <td class="bb-content">
                <p>Dear <strong>{{ customer_name }}</strong>,</p>
                <p>This is a reminder that your car rental ends <strong>tomorrow</strong>. Please return the car on time to avoid any extra charges.</p>
            </td>
        </tr>
        <tr>

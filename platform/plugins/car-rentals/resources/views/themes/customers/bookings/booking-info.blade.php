...
@if ($booking)
            ...
            <x-core::table.body>
                @foreach ($booking->insurances->unique() as $insurance)
                    <x-core::table.body.row>
                        ...
                        <x-core::table.body.cell class="text-center">{{ format_price($insurance->price, $booking->currency_id) }}</x-core::table.body.cell>
                    </x-core::table.body.row>
                @endforeach
            </x-core::table.body>
        </x-core::table>
    ...
    @if ($booking->damage_amount > 0)
        <div class="col-lg-4">
            ...
            @endphp
            <span class="label label-{{ $damageColor }} ms-1">

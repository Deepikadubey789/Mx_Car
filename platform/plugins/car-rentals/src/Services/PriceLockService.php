...
class PriceLockService
{
    ...
    public function createLock(array $quote): array
    {
        ...
        $snapshot = [
            ...
            'deposit_base_amount' => (float) ($quote['deposit_base_amount'] ?? 0),
            ...
            'deposit_risk_multiplier' => (float) ($quote['deposit_risk_multiplier'] ?? 1),
            'deposit_risk_level' => $quote['deposit_risk_level'] ?? 'standard',

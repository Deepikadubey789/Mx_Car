...
class ClaimStatusUpdatedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return $this->makeMailMessage(
            $notifiable,
            trans('plugins/car-rentals::disputes.notification_claim_status_updated_subject'),
            trans('plugins/car-rentals::disputes.notification_claim_status_updated_intro'),
            $this->booking,
            $this->claim
        );
    }
    ...
    public function toDatabase(object $notifiable): array
    {
        return $this->baseDatabasePayload(
            $this->booking,
            $this->claim,
            trans('plugins/car-rentals::disputes.notification_claim_status_updated_title'),
            trans('plugins/car-rentals::disputes.notification_claim_status_updated_message', [

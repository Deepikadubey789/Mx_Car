...
<div class="content-right cars-listing cars-listing-modern car-list-modern">
    ...
    <div class="modern-car-list-header mb-5 pb-4">
        
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-4">
            <div>
                <p class="text-uppercase text-muted fw-bold mb-2" style="font-size: 0.75rem; letter-spacing: 1.5px;">
                    {{ __('Curated Car Marketplace') }}
                </p>
                <h2 class="fw-bolder mb-0 display-6" style="letter-spacing: -0.5px;">
                    {{ __('Find the right ride in minutes') }}
                </h2>
            </div>
            
            <div class="mt-3 mt-md-0 d-flex align-items-center gap-3">
                <span class="badge bg-white text-dark border px-4 py-2 rounded-pill fs-6 fw-medium shadow-sm number-found">
                    {{ __(':total cars available', ['total' => $cars->total()]) }}
                </span>
                
                @if($enableFilter === 'yes')
                    <a type="button" class="btn btn-light border d-lg-none d-inline-flex align-items-center gap-2 rounded-pill px-3 btn-mobile-filter" data-bs-toggle="offcanvas" data-bs-target="#mobileFiltersOffcanvas" aria-controls="mobileFiltersOffcanvas">
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center bg-light rounded-4 p-3 px-4 gap-3 shadow-sm border border-light">
            
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted fw-bold small text-uppercase" style="letter-spacing: 1px;">{{ __('Layout') }}</span>
                
                <div class="box-view-type box-view-type-modern m-0">
                    <div class="layout-switcher-group bg-white rounded-3 shadow-sm p-1 d-flex">
                        <a @class(['display-type display-grid layout-car rounded-2', 'active' => $layout === 'grid']) href="#" data-layout="grid">
                        ...
                        <a @class(['display-type display-list layout-car rounded-2', 'active' => $layout === 'list']) href="#" data-layout="list">
            ...
            <div class="d-flex flex-wrap align-items-center gap-4">
                ...
                <div class="vr d-none d-sm-block text-black-50 opacity-25"></div>

                <div class="d-flex align-items-center gap-2">
                    <span class="text-muted fw-bold small text-nowrap text-uppercase" style="letter-spacing: 1px;">{{ __('Sort By') }}</span>
                    <div class="item-sort item-sort-modern bg-white shadow-sm rounded-3 border-0 m-0">
    ...
    <div class="box-grid-hotels car-list-cards wow fadeIn car-items">

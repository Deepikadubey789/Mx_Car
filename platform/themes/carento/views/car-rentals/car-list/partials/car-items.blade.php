...
<div class="content-right cars-listing cars-listing-modern car-list-modern">
    ...
    <div class="box-filters box-filters-modern mb-25">
        <div class="car-list-stage">
            <div class="car-list-stage__intro">
                <p class="car-list-stage__eyebrow mb-0">{{ __('Curated Car Marketplace') }}</p>
                <h5 class="car-list-stage__title mb-0">{{ __('Find the right ride in minutes') }}</h5>
            </div>

            <div class="car-list-stage__actions">
                <span class="text-sm-bold neutral-500 number-found">{{ __(':total cars available', ['total' => $cars->total()]) }}</span>
                <span class="car-list-stage__mode">
                    {{ $layout === 'grid' ? __('Grid preview') : __('List preview') }}
                </span>
                @if($enableFilter === 'yes')
                    <a type="button" class="d-lg-none d-inline-flex btn-mobile-filter btn-mobile-filter-modern car-list-stage__mobile-filter" data-bs-toggle="offcanvas" data-bs-target="#mobileFiltersOffcanvas" aria-controls="mobileFiltersOffcanvas">
        ...
        <div class="car-list-toolbar car-list-toolbar--rail">
            <div class="car-list-toolbar__left">
                <span class="car-list-toolbar__label">{{ __('Layout') }}</span>
                <div class="box-view-type box-view-type-modern">
            ...
            <div class="car-list-toolbar__right">
                <div class="box-item-sort box-item-sort-modern">
                    <div class="item-sort item-sort-modern border-1">
                        <span class="text-xs-medium neutral-500 mr-5">{{ __('Per page') }}</span>
